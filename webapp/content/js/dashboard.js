...
function doShare() {
  if (dashboardName == null) {
    Ext.Ajax.request({
      url: "/twiki/dashboard/create-temporary/",
      method: 'POST',
      params: {
...
function deleteDashboard(name) {
  Ext.Ajax.request({
    url: "/twiki/dashboard/delete/" + name,
    success: function (response) {
      var result = Ext.decode(response.responseText);
      if (result.error) {
